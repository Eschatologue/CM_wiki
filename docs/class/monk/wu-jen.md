...
You know the [:spell-lv0: Elementalism] cantrip and two cantrips of your choice from the Wu Jen spell list at the end of this subclass description. Whenever you gain a Monk level, you can replace one of this feature's cantrips with another cantrip of your choice from the Wu Jen spell list.
...
**Changing Cantrip**{ .inl } As a **:rsc-b: Bonus Action**{ .rsc } you can expend 1 **:class-phb24-monk: Focus Point(s)** to replace one of this feature's cantrips with another cantrip of your choice from the Wu Jen spell list.

**Restoring Spell Slots**{ .inl } As a **:rsc-b: Bonus Action**{ .rsc } on your turn, you can expend a number of **:class-phb24-monk: Focus Point(s)** equal to your Spell Slot Level to regain one of your expended Wu Jen spell slots.
...
You prepare a list of spells of level 1 and higher that are available for you to cast with this feature. To start, choose two level 1 spell from the [Wu Jen spell list].
...
When you take the **:rsc-a: Attack**{ .rsc } action to attack with a Monk weapon or an **:rsc-a: Unarmed Strike**{ .rsc } , you can replace one of your attack and imbue the magic of one Wu Jen cantrip you know into your attack. The cantrip you choose must have the following prerequisite:
...
When you hit your target with an attack using this feature, you can spend **1 :class-phb24-monk: Focus Point(s)** to choose one of the following effects:

**Forced Movement**{ .inl } You can move it 5 feet to an unoccupied space, provided the target is no more than one size larger than you.

**Teleport**{ .inl } You instantly teleport to an unoccupied space you can see within 5 feet of your target.
...
**Fly Speed**{ .inl } You gain Fly Speed equals to your Speed.
