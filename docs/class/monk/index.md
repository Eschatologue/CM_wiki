...
When an attack roll hits you and its damage includes :dmg-blunt: Bludgeoning, :dmg-piercing: Piercing, or :dmg-slashing: Slashing damage, you can take a :rsc-r: Reaction to reduce the attack's total damage against you. The reduction equals 1d10 plus your Dexterity modifier and Monk level.
