...
**Diminish Defiance**{ .inl } Enemies in the aura have **:d20-dis: Disadvantage**{ .d20 } on saving throws against your spells and Channel Divinity options.

**Regeneration**{ .inl } At the start of each of your turns, you regain 10 Hit Points.

**Swift Spells**{ .inl } Whenever you cast a spell that has a casting time of 1n action, you can cast it using a **:rsc-b: Bonus Action**{ .rsc } instead.
