...
!!! statblock "Steel Defender"
    ...
    ***Deflect Attack.*** The defender imposes **:d20-disadv: Disadvantage**{ .d20 } on the attack roll of one creature it can see that is within 5 feet of it, provided the attack roll is against a creature other than the defender.
