...
| **Starting Equipment** | Choose A, B, or C: (A) any two simple weapons of your choice, a light crossbow and 20 bolts (B) Studded Leather Armor, Thieves' Tools and a Dungeoneer's Pack, (C) 155 GP |
...
- Gain the following traits from the Core Artificer Traits table: Hit Point Die, proficiency with Simple weapons, and training with Light and Medium armor and Shields.
- Gain the Artificer's level 1 features, which are listed in the Artificer Features table.
...
**Cantrips**  
You know three cantrips of your choice from the Artificer spell list.

Whenever you gain a Artificer level, you can replace one of your cantrips with another cantrip of your choice from the Artificer spell list.
...
You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 spells from the Artificer spell list.
...
Wisdom is your spellcasting ability for your Artificer spells.

**Spellcasting Focus**  
You can use an Artisan Tool as a Spellcasting Focus for your Artificer spells. After you gain the Infuse Item feature at Level 2, you can also use any item bearing one of your infusions as a spellcasting focus.
...
You can now store a spell in an object. Whenever you finish a Long Rest, you can touch one simple or martial weapon or one item that you can use as a spellcasting focus, and you store a spell in it, choosing a level 1 or level 2 spell from the artificer spell list takes a Magic action to cast (you needn't have it prepared).
