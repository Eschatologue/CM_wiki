...
| 68 | A 1-inch cube, each side a different colour |
...
| 80 | A bronze pentacle with an etching of a rat's head in its centre |
...
| 94 | A mosaic tile with a multicoloured, glazed surface |
