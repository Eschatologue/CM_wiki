...
|:--|---|---|:-:|:-:|--:|
| *Club* | **1d4 :dmg-bldg: Bd.**{ .dmg-phys } | Light | **:wp-mas: Slow**{ .wp } | M. | 1 SP |
| *Dagger* | **1d4 :dmg-prcg: Ps.**{ .dmg-phys } | Finesse, Light, Thrown (:wp-prop-range: Range 20/60) | **:wp-mas: Nick**{ .wp } | S. | 20 SP |
| *Greatclub* | **1d8 :dmg-bldg: Bd.**{ .dmg-phys } | Two-Handed | **:wp-mas: Push**{ .wp } | M. | 2 SP |
| *Handaxe* | **1d6 :dmg-slsh: Sl.**{ .dmg-phys } | Light, Thrown (:wp-prop-range: Range 20/60) | **:wp-mas: Vex**{ .wp } | S. | 50 SP |
...
| Name | damage | properties | mastery | weight | cost |
|:--|---|---|:-:|:-:|--:|
| *Blowgun* | **1 :dmg-prcg: Ps.**{ .dmg-phys } | Ammunition (:wp-prop-range: Range 25/100; Needle), Loading | **:wp-mas: Vex**{ .wp } | S. | 100 SP |
| *Dart* (2) | **1d4 :dmg-prcg: Ps.**{ .dmg-phys } | Finesse, Thrown (:wp-prop-range: Range 20/60) | **:wp-mas: Vex**{ .wp } | XS. | 1 SP |
...
| *Flail* | **1d8 :dmg-bldg: Bd.**{ .dmg-phys } | — | **:wp-mas: Sap**{ .wp } | M. | 100 SP |
| *Glaive* | **1d10 :dmg-slsh: Sl.**{ .dmg-phys } | Heavy, Reach, Two-Handed | **:wp-mas: Graze**{ .wp } | L. | 200 SP |
| *Greataxe* | **1d12 :dmg-slsh: Sl.**{ .dmg-phys } | Heavy, Two-Handed | **:wp-mas: Cleave**{ .wp }  | L. | 300 SP |
| *Greatsword* | **2d6 :dmg-slsh: Sl.**{ .dmg-phys } | Heavy, Two-Handed | **:wp-mas: Graze**{ .wp } | L. | 500 SP |
| *Halberd* | **1d10 :dmg-slsh: Sl.**{ .dmg-phys } | Heavy, Reach, Two-Handed | **:wp-mas: Cleave**{ .wp }  | L. | 200 SP |
| *Lance* | **1d10 :dmg-prcg: Ps.**{ .dmg-phys } | Heavy, Reach, Two-Handed (unless mounted) | **:wp-mas: Topple**{ .wp } | L. | 100 SP |
| *Longsword* | **1d8 :dmg-slsh: Sl.**{ .dmg-phys } | Versatile (1d10; **:wp-mas: Agile**{ .wp }) | **:wp-mas: Sap**{ .wp } | M. | 150 SP |
| *Maul* | **2d6 :dmg-bldg: Bd.**{ .dmg-phys } | Heavy, Two-Handed | **:wp-mas: Topple**{ .wp } | L. | 100 SP |
| *Morningstar* | **1d8 :dmg-prcg: Ps.**{ .dmg-phys } | — | **:wp-mas: Sap**{ .wp } | M. | 150 SP |
| *Pike* | **1d10 :dmg-prcg: Ps.**{ .dmg-phys } | Heavy, Reach, Two-Handed | **:wp-mas: Push**{ .wp } | L. | 50 SP |
| *Rapier* | **1d8 :dmg-prcg: Ps.**{ .dmg-phys } | Finesse | **:wp-mas: Vex**{ .wp } | M. | 250 SP |
| *Sabre* | **1d8 :dmg-slsh: Sl.**{ .dmg-phys } | Finesse | **:wp-mas: Vex**{ .wp } | M. | 150 SP |
| *Scimitar* | **1d6 :dmg-slsh: Sl.**{ .dmg-phys } | Finesse, Light | **:wp-mas: Nick**{ .wp } | S.| 250 SP |
| *Shortsword* | **1d6 :dmg-prcg: Ps.**{ .dmg-phys } | Finesse, Light | **:wp-mas: Vex**{ .wp } | S.| 100 SP |
| *Trident* | **1d8 :dmg-prcg: Ps.**{ .dmg-phys } | Thrown (:wp-prop-range: Range 20/60), Versatile (1d10) | **:wp-mas: Topple**{ .wp } | M. | 50 SP |
| *Warhammer* | **1d8 :dmg-bldg: Bd.**{ .dmg-phys } | Versatile (1d10; **:wp-mas: Expose**{ .wp }) | **:wp-mas: Push**{ .wp } | M. | 150 SP |
| *War Pick* | **1d8 :dmg-prcg: Ps.**{ .dmg-phys } | Versatile (1d10; **:wp-mas: Vex**{ .wp }) | **:wp-mas: Sap**{ .wp } | M. | 50 SP |
| *Whip* | **1d4 :dmg-slsh: Sl.**{ .dmg-phys } | Finesse, Reach | **:wp-mas: Slow**{ .wp } | M. | 20 SP |
| *Estoc* | **1d8 :dmg-prcg: Ps.**{ .dmg-phys } | Versatile (1d10) | **:wp-mas: Sap**{ .wp } | M. | 100 SP |
| *Lucerne* | **1d10 :dmg-bldg: Bd.**{ .dmg-phys } | Heavy, Reach, Two-Handed | **:wp-mas: Expose**{ .wp } | L. | 200 SP |

##### Ranged Martial Weapons

| name | damage | properties | mastery | weight | cost |
|:--|---|---|:-:|:-:|--:|
| *Hand Crossbow* | **1d6 :dmg-prcg: Ps.**{ .dmg-phys } | Ammunition (:wp-prop-range: Range 30/120; Bolt), Light, Loading | **:wp-mas: Vex**{ .wp } | M. | 750 SP |
| *Heavy Crossbow* | **1d10 :dmg-prcg: Ps.**{ .dmg-phys } | Ammunition (:wp-prop-range: Range 100/400; Bolt), Heavy, Loading, Two-handed | **:wp-mas: Push**{ .wp } | M. | 500 SP |
