...
When you hit a Large or smaller creature with a Warlock cantrip, you can push that creature up to 10 feet straight away from you.
...
When any creature whose name is on the page drops to 0 Hit Points but isn't killed outright, it magically drops to 1 Hit Point instead. Once this magic is triggered, no creature can benefit from it until you finish a Long Rest.
...
When you hit a creature with your pact weapon, the creature takes extra Necrotic, Psychic, or Radiant damage (your choice), and you can expend a Hit Die to regain Hit Points equal to the extra damage dealt.
...
When you use your Thirsting Blade invocation, you can attack with your pact weapon three times, instead of two, when you take the Attack action on your turn.
