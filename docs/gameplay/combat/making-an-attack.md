...
## Attack Rolls
*Main article: [Dice Rolls](../dice-rolls.md)*
...
When you take the Attack action and attack with a *light* melee weapon that you're holding in one hand, you can use a :rsc-bonus-action: **:rsc-bonus-action: **Bonus Action**** to attack with a different *light* melee weapon that you're holding in the other hand. You don't add your ability modifier to the damage of the bonus attack, unless that modifier is negative.
