...
- When you force a creature to make a saving throw or a contested ability check, it make the saving throw or the ability check at a disadvantage.
...
- You have advantage on attack made using Strength and disadvantage on attack made using Dexterity.
- On each of your turn, you must make an attack to any creature that is within your reach.
- All creatures, including your ally can provoke opportunity attack from you, and you must use your reaction when available to make an attack.
...
- You are overcome with shaking, and have disadvantage on Dexterity saving throw.
...
- You can't take :material-star-four-points:**Reaction** and must roll a d10 at the start of each of your turns to determine a behavior for that turn.
...
- You have disadvantage on Strength, Dexterity, and Constitution saving throw.
