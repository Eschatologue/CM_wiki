...
The target gains a number of **:trt-thp: Temporary Hit Points**{.dmg-temp} equal to the Hit Points of the Beast form. The spell ends early on the target if it has no **:trt-thp: Temporary Hit Points**{.dmg-temp} left.
