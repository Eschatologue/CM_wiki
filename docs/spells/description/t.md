...
A creature of your choice that you can see within range perceives everything as hilariously funny and falls into fits of laughter if this spell affects it. The target must succeed on a :d20-save: Wisdom saving throw or fall prone, becoming incapacitated and unable to stand up for the duration. A creature with an Intelligence score of 4 or less isn't affected.

At the end of each of its turns, and each time it takes damage, the target can make another :d20-save: Wisdom saving throw. The target has :d20-adv: Advantage on the saving throw if it's triggered by damage. On a success, the spell ends.
...
***Cantrip Upgrade.*** This damage increases by 1d6 when you reach level 5 (2d6), 11 (3d6), and 17 (4d6).
...
***Cantrip Upgrade.*** The damage increases by one die when you reach level 5 (2d8 or 2d12), 11 (3d8 or 3d12), and 17 (4d8 or 4d12).
...
When the wall appears, each creature within its area must make a :d20-save: Strength saving throw. On a failed save, a creature takes 6d10 bludgeoning damage, or half as much damage on a successful save.

At the start of each of your turns after the wall appears, the wall, along with any creatures in it, moves 50 feet away from you. Any Huge or smaller creature inside the wall or whose space the wall enters when it moves must succeed on a Strength :d20-save: Strength saving throw or take 5d10 Bludgeoning damage. A creature can take this damage only once per round. At the end of the turn, the wall's height is reduced by 50 feet, and the damage creatures take from the spell on subsequent rounds is reduced by 1d10. When the wall reaches 0 feet in height, the spell ends.
