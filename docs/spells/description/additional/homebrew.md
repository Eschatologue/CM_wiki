...
You create an distruptive field around yourself. For the duration, Ranged attacks using weapons against you that deals **:dmg-bldg: Bludgeoning**{ .dmg-phys }, **:dmg-prcg: Piercing**{ .dmg-phys }, or **:dmg-slsh: Slashing**{ .dmg-phys } damage have **:d20-dis: Disadvantage**{ .d20 }. You also have **:dmg-res: Resistance** to **:dmg-bldg: Bludgeoning**{ .dmg-phys }, **:dmg-prcg: Piercing**{ .dmg-phys }, or **:dmg-slsh: Slashing**{ .dmg-phys } damage from Ranged weapons.
